...
set timing on;
--question 1)
select sum(QUANTITY) as total_quantity_purchased FROM ECOMMERCE 
where 
PURCHASE_DATE like '2019-02%'; 


--question 2)
select SUBSTR(Purchase_Date, 1, 4) as Year_of_Purchase,
...
--question 3)
select SUBSTR(Purchase_Date, 6, 2) as Month_of_purchase,
PRODUCTNO,sum(PRICE*QUANTITY) as sales_amount from ECOMMERCE 
where 
