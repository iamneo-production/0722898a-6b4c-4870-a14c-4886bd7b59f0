...
select sum(QUANTITY) as total_quantity from ecommerce 
...
select sum(PRICE * QUANTITY) as sale_amount,
...
select PRODUCTNO,extract(month from TO_DATE(PURCHASE_DATE,'YYYY-MM-DD')) as Sale_month,
